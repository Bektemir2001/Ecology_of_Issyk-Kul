...
class TLIService
{
	...
	public static $tliClassifications;
	...
	{
		if(self::$tliClassifications == null)
		{
			self::$tliClassifications = TrophicLevelIndex::all()->sortBy('item');
		}
		return self::$tliClassifications;
	}
}